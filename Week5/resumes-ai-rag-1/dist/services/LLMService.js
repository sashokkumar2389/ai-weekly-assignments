...
class LLMService {
    constructor() {
        ...
        this.rerankPrompt = fs_1.default.readFileSync(path_1.default.join(promptsDir, 'rerank.prompt.txt'), 'utf-8');
        this.summarizePrompt = fs_1.default.readFileSync(path_1.default.join(promptsDir, 'summarize.prompt.txt'), 'utf-8');
        this.extractMetadataPrompt = fs_1.default.readFileSync(path_1.default.join(promptsDir, 'metadata-extraction.prompt.txt'), 'utf-8');
    }
