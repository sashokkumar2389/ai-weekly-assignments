...
export interface FilterOptions {
    ...
    company?: string;
    education?: string;
    [key: string]: any; // Allow pass-through for direct MongoDB queries
}
 ...
 */
export function convertFilters(filters?: FilterOptions | object): object {
 ...
 */
export function getFilterDocumentation(): string {
    return `
 ...
 * Validate filters
 */
export function validateFilters(filters?: FilterOptions | object): { valid: boolean; errors: string[] } {
    const errors: string[] = [];
    ...
    if (
        typedFilters.minYearsExperience !== undefined &&
    ...
    if (
        typedFilters.minRelevantExperience !== undefined &&
