 ...
 */
export const validateSummarizeRequest = (req: Request, res: Response, next: NextFunction): void => {
 ...
 */
export const validateEmbeddingRequest = (req: Request, res: Response, next: NextFunction): void => {
