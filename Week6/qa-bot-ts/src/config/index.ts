...
// Support both current and legacy environment variable names.
const mongoDbName = process.env.MONGODB_DB_NAME || process.env.MONGODB_DB || "db_resumes";
const mongoCollection = process.env.MONGODB_COLLECTION || process.env.MONGO_RESUMES_COLLECTION || "resumes";
const mongoVectorIndexName = process.env.MONGODB_VECTOR_INDEX || process.env.MONGO_VECTOR_INDEX_NAME || "resume_vector_index";
